 ...
 namespace Voodoo.Analytics
{
    public static class VoodooAnalyticsManager
    {
        ...
        /// </summary>
        /// <param name="vanEventName">Event name</param>
        ...
        public static void TrackEvent(VanEventName vanEventName,
        ...
        {
            TrackEvent(vanEventName.ToString(), data, eventType, customVariables, contextVariables, eventId);
        }
                                      ...
                                      Dictionary<string, object> contextVariables = null)
        {
            ...
            InternalTrackEvent(vanEventName.ToString(), data, eventType, customVariablesJson, contextVariablesJson, eventId);
        }
