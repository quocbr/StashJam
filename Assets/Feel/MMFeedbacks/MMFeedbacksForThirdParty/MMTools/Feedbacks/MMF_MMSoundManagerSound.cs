...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_MMSoundManagerSound : MMF_Feedback
    {
        ...
        [Tooltip("the sound clip to play")] [MMFEnumCondition("Source", (int)Sources.AudioClip)]
        ...
        [Tooltip("the curve to use for custom spread if UseSpreadCurve is true")] [MMFCondition("UseSpreadCurve", true)]
        ...
        protected virtual void PlaySound(AudioClip sfx, Vector3 position, float intensity,
            AudioSource audioResource = null)
        {
            if (DoNotPlayIfClipAlreadyPlaying)
            {
                if (MMSoundManager.Instance.FindByClip(sfx) != null &&
                    MMSoundManager.Instance.FindByClip(sfx).isPlaying)
                {
                    return;
                }
            }
        ...
        public override string RequiredTargetText => Sfx != null ? Sfx.name + " - ID:" + ID : "";
        ...
        public virtual async void TestPlaySound()
        {
            ...
            PlayAudioSource(_editorAudioSource, tmpAudioClip, volume, pitch, _randomPlaybackTime,
                _randomPlaybackDuration, AudioResourceToPlay);
            _lastPlayTimestamp = FeedbackTime;
        ...
        protected virtual void PlayAudioSource(AudioSource audioSource, AudioClip sfx, float volume, float pitch,
            float time, float playbackDuration, AudioSource audioResourceToPlay)
        {
