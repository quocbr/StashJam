...
namespace EpicToonFX
{
    public class ETFXProjectileScript : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            projectileParticle =
                Instantiate(projectileParticle, myTransform.position, myTransform.rotation) as GameObject;
        ...
        private void FixedUpdate()
        {
            ...
            if (Physics.SphereCast(myTransform.position, rad, dir, out hit, dist))
            {
                ...
                GameObject impactP = Instantiate(impactParticle, myTransform.position,
